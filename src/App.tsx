 ...
 *
 * v0.1 · title screen. Domain logic ports from docs/simulations/
...
function EnterButton() {
  return (
    <button
      ...
      onClick={() => {
        // scenes/lobby not yet wired — placeholder.
        console.log('Entra al Ballo')
      }}
    >
